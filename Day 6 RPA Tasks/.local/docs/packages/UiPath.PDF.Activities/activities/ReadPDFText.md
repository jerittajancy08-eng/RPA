...
| `PreserveFormatting` | Preserve formatting | `InArgument` | `bool` | | `false` | | When `true`, whitespace and layout formatting from the PDF are preserved in the extracted text. |
