...
A set of activities for working with PDF and XPS documents: read text, extract images and attachments, export pages as images, join and split PDF files, manage passwords, and convert HTML, plain text, and email content to PDF.
...
| [Extract Attachments from PDF](activities/ExtractAttachmentsFromPDF.md) | Extract files embedded as attachments in a PDF document (e.g. XML or Word files) and save them to a folder. |
